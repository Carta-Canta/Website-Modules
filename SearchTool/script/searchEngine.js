...
document.getElementById('generateDiv').addEventListener("click", ()=>{
    document.getElementById("articoli").style.display="none"; //boosto la generazione
    let maxi=20000;
    for(let i=0; i<maxi; i++){
        document.getElementById("articoli").innerHTML+=`<div id="art${i}"><h2>Articolo ${i}</h2><p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quod culpa corrupti sapiente animi, rem quaerat adipisci omnis tenetur facilis? Quos, natus! Architecto, illo nostrum. Voluptas explicabo eos molestiae doloremque voluptatem?</p>`;
    }
    document.getElementById("articoli").style.display="block";
    defaultPage=document.getElementById("articoli").innerHTML;
})